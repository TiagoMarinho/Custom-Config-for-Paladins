class VideoSettings {
	constructor () {
		let settings = {
			resolutionScale: {name: "Resolution Scale", type: RangeOption}
		}


		this.options = [
			new RangeOption("Resolution Scale", 10, 100, 65, "Which resolution the 3D scene will be rendered with."),
			new BoolOption("Decals", 1, "Disabling decals will prevent sprays, Mal'Damba gourd texture and Viktor ult markers from being displayed."),
